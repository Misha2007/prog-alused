...
print(create_list_of_two_elements(3, 4))
print(create_list_with_edge_elements([1]))
print(get_middle_element_of_list(["a","b"]))
print(get_middle_part_of_list([1,2]))
...
x = [453]
print(remove_first_element_from_list(x))
