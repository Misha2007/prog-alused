...
def insert_tuple_inside_tuple(outer_tuple: tuple, position: int, inner_tuple: tuple) -> tuple:
    ...
    """
    new_tuple = outer_tuple[:position]
    if position >= len(outer_tuple):
...
print(create_tuple_from_two_numbers(1, 1))

print(create_tuple_up_to_n(-10))

print(merge_tuples((1, 2), (3, 4)))

print(remove_odd_numbers((4, 2, 3)))

print(insert_tuple_inside_tuple((1, 2, 3), 1, (1, )))